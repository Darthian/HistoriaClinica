...
public class PacienteMB {
	...
	public void guardarPaciente() {
		...
		Paciente paciente = new Paciente(nombre_Paciente, edad, fecha_Nacimiento, cedula, procedencia, genero, eps, estado_Financiero, ocupacion, estado_Civil, escolaridad, telefono, fecha_creacion);
